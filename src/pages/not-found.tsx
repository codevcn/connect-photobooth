...
export default function NotFound() {
  return (
    <div className="h-screen w-screen bg-linear-to-br from-superlight-pink-cl via-light-pink-cl to-pink-50 flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl w-full">
        ...
        <div className="text-center mb-8">
          <h1 className="text-[12rem] font-black leading-none bg-linear-to-br from-pink-cl via-pink-hover-cl to-dark-pink-cl bg-clip-text text-transparent drop-shadow-2xl animate-pulse-slow select-none">
            404
          </h1>
