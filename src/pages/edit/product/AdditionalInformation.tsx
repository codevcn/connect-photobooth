...
export const AdditionalInformation = ({ productDescription }: TAdditionalInformationProps) => {
  ...
  return (
    <div className="flex flex-col gap-1 w-full max-w-md bg-gray-100 rounded-lg shadow-sm p-2 border-border">
      ...
      <div className="group flex items-center justify-between p-4 cursor-pointer hover:bg-white border-border rounded-md transition-colors">
        <div className="flex items-center gap-4">
          <div className="text-gray-800">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="text-gray-700 font-semibold text-base">Personalization</span>
        </div>
        <div className="text-gray-600 group-hover:text-gray-800">
          <svg
            xmlns="http://www.w3.org/2000/svg"
