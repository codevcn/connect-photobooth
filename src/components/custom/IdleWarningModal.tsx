      ...
      <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full mx-4 border-4 border-pink-cl animate-scale-in">
        ...
        <div className="flex justify-center mb-6">
          <div className="relative">
            ...
            <div className="relative bg-linear-to-br from-pink-cl to-pink-hover-cl p-5 rounded-full shadow-lg">
              <svg
        ...
        {/* Countdown */}
        <div className="bg-linear-to-br from-pink-cl/10 to-pink-hover-cl/10 rounded-2xl p-6 mb-6 border-2 border-pink-cl/30">
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-2">
              <div className="bg-white rounded-xl px-6 py-3 shadow-md border-2 border-pink-cl">
                <span className="text-4xl font-bold text-pink-cl tabular-nums">{countdown}</span>
              </div>
        ...
        <button
          onClick={onConfirm}
          className="w-full bg-linear-to-r from-pink-cl to-pink-hover-cl hover:from-dark-pink-cl hover:to-pink-cl text-white font-bold text-lg py-4 px-6 rounded-xl shadow-lg hover:shadow-xl active:scale-95 transition-all duration-200 flex items-center justify-center gap-3"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
